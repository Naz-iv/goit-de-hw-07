...
os.environ["AIRFLOW_CONFIG"] = "C:/Users/nivankiv/airflow/airflow.cfg"
...
with DAG(
    ...
    create_table = MySqlOperator(
        ...
        sql="""
        CREATE TABLE IF NOT EXISTS nazarivankiv_medal_counts (
    ...
    calc_Bronze = MySqlOperator(
        ...
        mysql_conn_id=connection_name,
        sql="""
        INSERT INTO nazarivankiv_medal_counts (medal_type, count)
        SELECT 'Bronze', COUNT(*)
    ...
    check_for_correctness = SqlSensor(
        ...
        sql="""
    SELECT 1
    FROM nazarivankiv_medal_counts
